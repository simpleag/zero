   var pro = [" ","北京","天津","上海","重庆","河北","山西","辽宁","吉林","黑龙江","江苏","浙江","安徽","福建","江西","山东","河南","湖北","湖南","广东","海南","四川","贵州","云南","陕西","甘肃","青海","内蒙古","广西","西藏","宁夏","新疆维吾尔自治区","香港","澳门","台湾"];
    ...
    var school = {海淀区:["北京大学"],东城区:["清华大学医学部"],杭州:["浙江大学","浙江大学城市学院","杭州电子科技大学"]};

    $(document).ready(function(){
        var flag = 1;
        $("#showTooltips").attr("class","weui-btn weui-btn_disabled weui-btn_primary");
        //点击确认时检查是否出错 并控制出错信息显隐
        $("#showTooltips").click(function(){
            ...
            if(document.getElementById("name").value==""){
                ...
                if(document.getElementById("number").value==""){
                    $("#number").focus();
                    document.getElementById("number-warn").style.display="block";
                    //出现顶部错误提示信息
                    document.getElementById("warn").style.display="block";
                    //2秒后自动隐藏 
                    setTimeout( function nonewarn(){ 
        ...
        $("#select-city").click(function(){
            var shcool=school[$(this).val()];
            $("#select-school").empty();
            for(var i=0;i<shcool.length;i++){
                $option=$("<option/>")
                $option.attr("value",shcool[i]);
                $option.text(shcool[i]);
                // $(this).parent().find(".city").append($option);
